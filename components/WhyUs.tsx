        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-24 items-center'>
          ...
          <div className='order-2 lg:order-1 max-w-xl'>
            ...
            <div className='mt-16 grid grid-cols-2 gap-12 border-t border-secondary/10 pt-12'>
              <div>
                <span className='block text-4xl font-serif font-light text-secondary mb-2'>
                  13th
                </span>
                <span className='text-[10px] font-sans font-black tracking-[0.2em] text-zinc-400 uppercase'>
                  Warisan di Dunia Busana
                </span>
              </div>
              <div>
                <span className='block text-4xl font-serif font-light text-secondary mb-2'>
          ...
          <div className='order-1 lg:order-2 relative'>
            ...
            <div className='absolute -bottom-12 -left-12 hidden md:block bg-white p-12 max-w-xs shadow-2xl'>
              <span className='text-[8px] font-sans font-black tracking-[0.4em] text-primary uppercase mb-4 block'>
                Keahlian Kerajinan
              </span>
              <p className='text-sm font-serif italic text-secondary/60 leading-relaxed'>
                Tangan-tangan ahli yang memastikan setiap detail jahitan adalah
                bukti nyata dari kasih sayang untuk buah hati Anda.
              </p>
            </div>
          </div>
        </div>
