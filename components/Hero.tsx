...
export default function Hero() {
  return (
    <header className="relative pt-36 pb-20 md:pt-52 md:pb-40 overflow-hidden bg-surface">
      ...
      <div className="absolute top-20 left-10 w-64 h-64 bg-amber-200/20 blur-[100px] rounded-full pointer-events-none animate-pulse"></div>
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-pink-200/20 blur-[120px] rounded-full pointer-events-none animate-bounce duration-[10s]"></div>
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col items-start text-left">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border-2 border-amber-200 bg-white px-5 py-2 text-xs sm:text-sm font-black text-amber-600 uppercase tracking-tighter shadow-sm animate-in fade-in slide-in-from-left duration-700">
            ...
            <p className="mt-8 max-w-xl text-lg leading-relaxed text-zinc-500 sm:text-xl font-medium animate-in fade-in slide-in-from-bottom duration-700 delay-200">
              Transform your passion for kids fashion into a thriving enterprise. Join <span className="text-zinc-900 font-bold underline decoration-amber-400 decoration-4">700+ successful partners</span> and earn up to <span className="text-pink-500 font-black">Rp 80 Juta/Bulan</span>.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 animate-in fade-in slide-in-from-bottom duration-700 delay-300">
              <a
                href="#tiers"
                className="w-full sm:w-auto flex items-center justify-center gap-3 rounded-2xl bg-zinc-900 px-8 py-5 text-lg font-black text-white transition-all hover:bg-zinc-800 hover:scale-105 active:scale-95 shadow-2xl shadow-zinc-900/20 group"
              >
                Get Started Now
                <ArrowRight
                  size={22}
                  className="transition-transform group-hover:translate-x-1 text-amber-400"
                />
              </a>
              
              <button className="w-full sm:w-auto flex items-center justify-center gap-3 rounded-2xl bg-white border-2 border-zinc-100 px-8 py-5 text-lg font-black text-zinc-900 transition-all hover:border-amber-400 bouncy-hover shadow-sm">
          ...
          <div className="relative hidden lg:block animate-in fade-in zoom-in duration-1000 delay-200">
            ...
            <div className="relative rounded-4xl overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.2)] border-[12px] border-white rotate-2 hover:rotate-0 transition-transform duration-700">
              <img
            ...
            {/* Small Floating Card */}
            <div className="absolute -bottom-6 -right-6 glass rounded-3xl p-5 shadow-2xl animate-bounce duration-[4s]">
