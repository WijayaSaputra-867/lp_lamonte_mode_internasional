...
const CATALOG_ITEMS = [
  {
    ...
    image: "https://images.unsplash.com/photo-1519234164452-45da053d537a?auto=format&fit=crop&q=80&w=800",
  },
  {
    title: "Essential Sets",
    category: "Import Choice",
    image: "https://images.unsplash.com/photo-1522771935876-249711cd39fd?auto=format&fit=crop&q=80&w=800",
  },
  {
    title: "Signature Dresses",
    category: "Signature Series",
    image: "https://images.unsplash.com/photo-1544122159-39c8a8856988?auto=format&fit=crop&q=80&w=800",
  },
  {
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
          <div className="max-w-xl">
            ...
            <h2 className="text-4xl md:text-7xl font-serif font-light text-secondary leading-tight">
              A Selection of <span className="italic">Timeless</span> Works.
            </h2>
          </div>
          <p className="text-base font-serif italic text-secondary/60 max-w-xs md:mb-4">
            Setiap koleksi dikurasi untuk memberikan kenyamanan maksimal bagi si kecil, tanpa melupakan estetika yang menawan.
          </p>
        </div>
