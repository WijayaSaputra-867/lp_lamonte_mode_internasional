      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-24 text-center">
          ...
          <h2 className="text-5xl md:text-8xl font-serif font-light text-secondary leading-tight tracking-tight">
            Stories <span className="italic">of Progress.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          {TESTIMONIALS_DATA.map((testimonial, i) => (
            ...
            >
              ...
              <div>
                <span className="block text-lg font-serif font-medium text-secondary">{testimonial.name}</span>
                <span className="text-[10px] font-sans font-black tracking-widest text-zinc-300 uppercase">{testimonial.role}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-32 flex justify-center">
           <div className="max-w-2xl text-center p-12 border border-secondary/5 bg-surface-muted italic">
              <p className="text-base font-serif text-secondary/60 leading-relaxed mb-8">
                &quot;Kesuksesan sejati bukan diukur dari seberapa banyak yang kita ambil, tapi dari seberapa besar dampak yang kita beri kepada sesama.&quot;
              </p>
              <span className="text-[10px] font-sans font-black tracking-widest text-secondary uppercase">The Lamonte Creed</span>
           </div>
        </div>
      </div>
    </section>
