...
export default function Features({
  ...
  return (
    <section id="features" className="py-32 bg-surface-muted relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="mb-24 flex flex-col items-center text-center">
          ...
          <h2 className="text-5xl md:text-8xl font-serif font-light text-secondary leading-tight tracking-tight">
            Comprehensive <br /> <span className="italic">Empowerment.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-24 gap-x-12">
          {featuresToRender.map((feature, i) => (
            ...
            >
              <div className={`mb-10 lg:mb-0 shrink-0 ${feature.isLarge ? "lg:w-1/2" : "w-full"}`}>
