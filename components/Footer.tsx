        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32'>
          <div className='lg:col-span-2'>
            ...
            <p className='max-w-md text-base font-serif italic text-secondary/60 leading-relaxed mb-10'>
              Membangun masa depan fashion anak melalui kualitas, integritas,
              dan dedikasi yang tak tergoyahkan untuk generasi mendatang.
            </p>
          ...
          <div>
            <span className='text-[10px] font-sans font-black tracking-[0.3em] text-secondary uppercase mb-8 block'>
              Navigasi
            </span>
          ...
          <div>
            ...
            <ul className='space-y-6 font-serif italic text-secondary/70'>
              <li className='flex items-start gap-3'>
                <MapPin
                  size={18}
                  className='text-primary shrink-0 transition-transform hover:scale-110'
                />
